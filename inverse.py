...
def Decryption(model, shape, hr, lr, t):
    ...
    for i in range(step, -1, -1):
        ...
        if i == step:
            ...
            # print(img)
            viz.images(img2, nrow=2, win='gen_img', opts={'title': 'gen_img'})
            viz.text(i, win='loop')
        else:
...
def inverse():
    ...
    for step, (lr, hr) in enumerate(loader):
        ...
        viz.images(lr, nrow=2, win='lr', opts={'title': 'lr'})
        viz.images(hr, nrow=2, win='hr', opts={'title': 'hr'})
